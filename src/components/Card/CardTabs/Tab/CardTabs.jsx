    ...
    return (
        <ul className={`${s.card__schedule} ${s.scheduleTabs}`}>
            <li className={`${s.schedule__item} ${s.schedule__item_active}`}>
                <NavLink activeClassName={s.active} className={`${s.schedule__link} ${s.tabs}`}  exact to={"/"}>Расписание
                    занятий</NavLink>
            ...
            <li className={s.schedule__item}>
                <NavLink activeClassName={s.active} className={`${s.schedule__link} ${s.tabs}`} to={"/schedule/sensei"}>Расписание преподавателей</NavLink>
            ...
            <li className={s.schedule__item}>
                <NavLink activeClassName={s.active} className={`${s.schedule__link} ${s.tabs} `} to={"/traffic"}>Загруженность аудиторий</NavLink>
